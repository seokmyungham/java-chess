    ...
    void positionWithOpponentPiecesTest() {
        ...
        Board board = new Board(
                Map.of(
                        ...
                        new Position(Row.SIX, Column.D),  new Piece(PieceType.KNIGHT, Color.BLACK),
                        ...
                        new Position(Row.FOUR, Column.E),  new Piece(PieceType.BLACK_PAWN, Color.BLACK),
                        new Position(Row.FOUR, Column.D),  new Piece(PieceType.BLACK_PAWN, Color.BLACK),
    ...
    void positionWithOwnPiecesTest() {
        ...
        Board board = new Board(
                Map.of(
                        ...
                        new Position(Row.SIX, Column.D),  new Piece(PieceType.KNIGHT, Color.WHITE),
                        new Position(Row.SIX, Column.E),  new Piece(PieceType.WHITE_PAWN, Color.WHITE),
                        new Position(Row.FIVE, Column.E),  new Piece(PieceType.WHITE_PAWN, Color.WHITE),
                        new Position(Row.FOUR, Column.E),  new Piece(PieceType.WHITE_PAWN, Color.WHITE),
                        new Position(Row.FOUR, Column.D),  new Piece(PieceType.WHITE_PAWN, Color.WHITE),
